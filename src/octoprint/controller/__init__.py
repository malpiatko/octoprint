...
#!/usr/bin/env python3
# class to drive the Trill Touch sensor by Mike Cook December 2020
# requires smbus2 - pip3 install simbus2
...
trillSize = [ [1.0, 1.0, 1.0], [3200.0, 1.0, 1142.5], [1792.0, 1792.0, 945.0], [4096.0, 1.0, 1.0], [3584.0, 1.0, 1250.0], [1920.0, 1664.0, 1000.0]]
